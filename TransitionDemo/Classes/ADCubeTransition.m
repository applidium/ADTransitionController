...
- (id)initWithDuration:(CFTimeInterval)duration orientation:(ADTransitionOrientation)orientation sourceRect:(CGRect)sourceRect {
    ...
    if (self != nil) {
        ...
        zTranslationAnimation.values = [NSArray arrayWithObjects:[NSNumber numberWithFloat:0.0f], [NSNumber numberWithFloat:-36.0f], [NSNumber numberWithFloat:0.0f], nil];
        ...
        [(CAAnimationGroup *)animation setAnimations:[NSArray arrayWithObjects:cubeRotation, zTranslationAnimation, nil]];
